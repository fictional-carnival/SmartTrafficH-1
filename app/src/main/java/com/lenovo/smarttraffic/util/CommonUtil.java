...
public class CommonUtil {
	...
	private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(InitApp.getContext());
	...
	public static Resources getResources(){
		return InitApp.getContext().getResources();
	}
	 ...
	 */
	public int getColor() {
		int defaultColor = InitApp.getContext().getResources().getColor(R.color.colorPrimary);
